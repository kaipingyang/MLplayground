...
def introduction():
    st.title("**Welcome to CMC ML Playground 🏭**")
    st.subheader(
        """
    ...
    st.markdown(
        """
    - 🗂 Choose a dataset(Template dataset or upload from your lab)
...
def footer():
    ...
    st.sidebar.markdown(
        """
        [<img src='data:image/png;base64,{}' class='img-fluid' width=150>](https://beigeneo365.sharepoint.com/sites/GlobalStatisticsDataScience)
        
        <small> CMC, ML Playground | Dec 2021</small>""".format(
            img_to_bytes("./images/BGNE-logo.png")
        ),
